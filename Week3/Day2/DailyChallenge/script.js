...
let stories =
	...
	`${name} awoke from a terrible nightmare. In his dream, there was a ${noun}, and then another, and another - each more ${adjective2} than the last, all ${verb} in a row. "Now you're coming with us to ${place}!" they shouted. "But how could I go there?!" ${name} cried. "It's too ${adjective1}!`]
